...
get_filename_component(_qt5Gui_install_prefix "${CMAKE_CURRENT_LIST_DIR}/../../src/QT/" ABSOLUTE)
...
if (NOT TARGET Qt5::Gui)
    ...
    set(_Qt5Gui_OWN_INCLUDE_DIRS "${_qt5Gui_install_prefix}/" "${_qt5Gui_install_prefix}/QtGui")
    set(Qt5Gui_PRIVATE_INCLUDE_DIRS
        "${_qt5Gui_install_prefix}/QtGui/5.14.1"
        "${_qt5Gui_install_prefix}/QtGui/5.14.1/QtGui"
    )
